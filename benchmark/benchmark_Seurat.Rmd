...
svg("umap_seurat.svg", width = 10, height = 8) 
...
svg("threshold_seurat.svg", width = 8, height = 6) 
...
write.csv(markers, 'seurat_cluster_markers.csv', quote = FALSE)
...
svg("heat_seurat.svg", width = 8, height = 8) 
