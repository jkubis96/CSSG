...
# https://github.com/princethewinner/FiRE?tab=readme-ov-file#usage-R
...
#### UMAP Plot – Seurat approach clusters with FiRE rare cell types visualized with Seurat-Based Dimensionality Reduction (UMAP/PCA)
...
svg("umap_FiRE.svg", width = 10, height = 8) 
...
#### Cells content in clusters with FiRE rare cell typess [n]
...
svg("threshold_FiRE.svg", width = 8, height = 6) 
...
write.csv(markers, 'FiRE_cluster_markers.csv', quote = FALSE)
...
#### Top 2 markers for clusters with FiRE rare cell types
...
svg("heat_FiRE.svg", width = 8, height = 8) 
